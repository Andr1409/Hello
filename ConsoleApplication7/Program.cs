...
namespace ConsoleApplication2
{
    ...
    class Program
    {
 ...
 
        {
            ...
            CA obj1 = new CA(5, 7); Console.WriteLine("x={0,2} y={1,2} z={2,2}", obj1.x, obj1.y, obj1.z);
            CA obj2 = new CA(8, 9, 25); Console.WriteLine("x={0,2} y={1,2} z={2,2}", obj2.x, obj2.y, obj2.z);
